        ...
        <div className="carousel-item">
          <div className="bg-neutral rounded-lg border shadow-md max-w-xs overflow-hidden rounded-box">
            ...
            <div className="p-3 flex flex-col">
              <span className="w-full text-sm text-primary-content">Apr 2022</span>
              ...
              <div className='h-full'>
                <div className="self-end">
                  <a href="https://github.com/Blec333/adventureQuest" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Repo</button></a>
                  <a href="https://adventurequest.herokuapp.com/" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Deployment</button></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-neutral rounded-lg border shadow-md max-w-xs overflow-hidden rounded-box">
            ...
            <div className="p-3">
              ...
              <p className="text-primary-content"> Server API fetch project providing various geolocation based
                information in
                real time.</p>
              <a href="https://github.com/Blec333/the-travel-center" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Repo</button></a>
              <a href="https://Blec333.github.io/the-travel-center/" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Deployment</button></a>
            </div>
          </div>
        </div>
        <div className="carousel-item">
          <div className="bg-neutral rounded-lg border shadow-md max-w-xs overflow-hidden rounded-box">
            ...
            <div className="p-3">
              ...
              <a href="https://github.com/Blec333/weather-dashboard" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Repo</button></a>
              <a href="https://Blec333.github.io/weather-dashboard/" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Deployment</button></a>
            </div>
          </div>
        </div>
        <div className="carousel-item">
          <div className="bg-neutral rounded-lg border shadow-md max-w-xs overflow-hidden rounded-box">
            ...
            <div className="p-3">
              ...
              <p className="text-primary-content"> Set priorities by each one hour block of your work day, memory remains
                persistant.</p>
              <a href="https://github.com/Blec333/day-planner" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Repo</button></a>
              <a href="https://Blec333.github.io/day-planner/" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Deployment</button></a>
            </div>
          </div>
        </div>
        <div className="carousel-item">
          <div className="bg-neutral rounded-lg border shadow-md max-w-xs overflow-hidden rounded-box">
            ...
            <div className="p-3">
              ...
              <a href="#portfolio" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Repo</button></a>
              <a href="#portfolio" rel="noreferrer" target="_blank"><button className="btn btn-secondary text-primary-content text-center">Deployment</button></a>
            </div>
          </div>
        </div>
        <div className="carousel-item">
